...
managers_data = [
  { name: 'mori',       short_name: 'mori',       irc_name: 'mori',
    teams: [ '若尊バレーナ' ] },
  { name: '紫安',        short_name: '紫安',        irc_name: '紫安',
    teams: [ 'ZERO～輝く夜に', '東京渋谷ファンタジー' ] },
  { name: 'こりゆの',    short_name: 'こりゆの',    irc_name: 'こりゆの',
    teams: [ '足立ストレイドッグス' ] },
  { name: '智夜',        short_name: '智夜',        irc_name: '智夜',
    teams: [ '小倉ダークペガサス' ] },
  { name: '藍翠',        short_name: '藍翠',        irc_name: '藍翠',
    teams: [ '姫路グランフェスタシクサーズ' ] },
  { name: 'badferd',    short_name: 'badferd',    irc_name: 'badferd',
    teams: [ '川崎ダイス' ] },
  { name: '植田',        short_name: '植田',        irc_name: '植田',
    teams: [ '森ノ宮スイートネイルズ' ] },
  { name: 'Marshal',    short_name: 'Marshal',    irc_name: 'Marshal',
    teams: [ '厚木パフォーマーズ' ] },
  { name: 'MiyaK',      short_name: 'MiyaK',      irc_name: 'MiyaK',
    teams: [ 'MiyaKコブラズ' ] },
  { name: 'けいようし',  short_name: 'けいようし',  irc_name: 'けいようし',
    teams: [ '飯能レポランタ', '全越谷' ] },
  { name: 'Trippy',     short_name: 'Trippy',     irc_name: 'Trippy',
    teams: [ '水元アルシオネ', '亀有アイアンカップス' ] },
  { name: 'cyan',       short_name: 'cyan',       irc_name: 'cyan',
    teams: [ '永山アストライア' ] },
  { name: 'かじわら',    short_name: 'かじわら',    irc_name: 'かじわら',
    teams: [ '下灘ムーンライツ' ] },
  { name: 'ゆだ',        short_name: 'ゆだ',        irc_name: 'ゆだ',
    teams: [ 'PADAK' ] },
  { name: 'マゼラン',    short_name: 'マゼラン',    irc_name: 'マゼラン',
    teams: [ '前橋ファランクス' ] },
  { name: 'Aal',        short_name: 'Aal',        irc_name: 'Aal',
    teams: [ '墨染アルヘナ' ] },
  { name: 'れもん',      short_name: 'れもん',      irc_name: 'れもん',
    teams: [ '星港ロアーズ' ] },
  { name: 'pontiti',    short_name: 'pontiti',    irc_name: 'pontiti',
    teams: [ '大勝ビクトリーズ' ] },
  { name: 'ふぁん',      short_name: 'ふぁん',      irc_name: 'ふぁん',
    teams: [ '幻奏ファントムスター' ] },
  { name: 'takky',      short_name: 'takky',      irc_name: 'takky',
    teams: [ '洗苫ヘリアンタス' ] },
  { name: 'werg',       short_name: 'werg',       irc_name: 'werg',
    teams: [ '時安スプリングス' ] },
  { name: 'じょーかー',  short_name: 'じょーかー',  irc_name: 'じょーかー',
    teams: [ '粟生ダウンヒルズ' ] },
  { name: '黒坂',        short_name: '黒坂',        irc_name: '黒坂',
    teams: [ '小名浜ハーバーラークス' ] },
  { name: '蒼真',        short_name: '蒼真',        irc_name: '蒼真',
    teams: [ '偏蘇兒フリーデルクラフツ' ] },
  { name: 'タイカ',      short_name: 'タイカ',      irc_name: 'タイカ',
    teams: [ '名護スクガラス' ] },
  { name: 'ひいらぎ',    short_name: 'ひいらぎ',    irc_name: 'ひいらぎ',
    teams: [ '汐止セイレンス' ] },
  { name: 'るぅ',        short_name: 'るぅ',        irc_name: 'るぅ',
    teams: [ '爆裂野球倶楽部' ] },
  { name: 'ピーちゃん',  short_name: 'ピーちゃん',  irc_name: 'ピーちゃん',
    teams: [ '対馬ストロングキャッツ' ] },
  { name: '鈴鹿',        short_name: '鈴鹿',        irc_name: '鈴鹿',
    teams: [ '南都シルクロード' ] },
  { name: 'ガブリチュウ', short_name: 'ガブリチュウ', irc_name: 'ガブリチュウ',
    teams: [ '筋肉マッスルパワーズ' ] },
  { name: 'つばると',    short_name: 'つばると',    irc_name: 'つばると',
    teams: [ '尾張スワローズ' ] }
]
